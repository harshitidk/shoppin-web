...
function Home(){
    ...
    <div className='relative flex-1 w-fit md:mt-12 overflow-y-auto snap-y snap-mandatory md:overflow-visible md:flex md:justify-center md:items-end'>
         <div className="group_of_screens flex flex-col items-center gap-y-24 md:gap-0 md:flex-row md:justify-center md:-space-x-10 pb-[50vh]">
             ...
             {/* Phone 1: Virtual Tryon */}
              <div className='snap-start sticky top-10 md:static relative md:z-0 transform-gpu transition-transform md:hover:-translate-y-2 md:translate-y-12'>
            ...
            <div className='snap-start sticky top-10 md:static relative md:z-10 transform-gpu transition-transform md:hover:-translate-y-2 md:translate-y-12'>
            ...
            <div className='snap-start sticky top-10 md:static relative z-50 md:z-20 transform-gpu transition-transform md:hover:-translate-y-2 md:translate-y-12'>
